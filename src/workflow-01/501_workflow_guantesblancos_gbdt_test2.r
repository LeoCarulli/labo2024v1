...
HT_tuning_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    min_gain_to_split = c( 0.1, 1.0 ), # min_gain_to_split >= 0.0
    min_sum_hessian_in_leaf = c( 0.001, 0.5 ), #  min_sum_hessian_in_leaf >= 0.0
    ...
    scale_pos_weight = c( 0.1, 1.0), # scale_pos_weight > 0.0
