...
DR_drifting_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/wgpc531_DR_corregir_drifting.r" # Experimento Pablo

  # No me engraso las manos con Feature Engineering manual
  param_local$variables_intrames <- TRUE
  param_local$variables_iter1 <- TRUE # Experimento Pablo
  param_local$variables_iter2 <- TRUE # Experimento Pablo
  # valores posibles
