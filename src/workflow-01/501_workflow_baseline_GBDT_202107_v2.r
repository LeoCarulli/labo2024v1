...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/expgbdt2/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flowgbdt2/"
envg$EXPENV$wf_dir_local <- "~/flowgbdt2/"
...
param_local$train$testing <- c(202105)
  ...
  # Atencion  0.1  de  undersampling de la clase mayoritaria,  los CONTINUA
  # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA
  param_local$train$undersampling <- 0.2 # elijo quedarme con el 50%, de los CONTINUA, debería ser buena estimación.
